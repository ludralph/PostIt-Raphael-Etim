...
const store = mockStore({ messages: {}, users: {} });
...
describe('Group Member Component', () => {
  ...
  it(`should call the addUserToGroup method when the add user button is 
    clicked`, () => {
    const wrapper = setup(groupMember.users);
    const addUserToGroupSpy = jest.spyOn(wrapper.instance(), 'addUserToGroup');
  ...
  it('should render the connected component', () => {
    const connectedComponent =
      shallow(<ConnectedGroupMember {...props} store={store}/>);
